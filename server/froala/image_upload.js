...
function isFileValid(filename, mimetype) {
  var allowedExts = ["txt", "pdf", "doc", "png", "jpeg", "jpg"];
  var allowedMimeTypes = ["text/plain", "application/msword", "application/x-pdf", "application/pdf", "image/png", "image/jpeg"];
...
function upload (req, callback) {
  ...
  busboy.on("file", function(fieldname, file, filename, encoding, mimetype) {
    ...
    diskWriterStream.on("finish", function() {
      ...
      return callback(null, {link: imageLink});
    });
